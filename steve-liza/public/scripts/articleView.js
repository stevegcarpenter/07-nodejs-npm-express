...
articleView.submit = event => {
  ...
  // It is a new method that is defined for the Article constructor as a prototype method. Once the user fills in the form and clicks the submit button on the new page this will insert the article into the index.html.
